...
%%%%%% this is the one used for peds studies EHM 08/25/2016, based off of  'audapter_matlab' below

elseif (nargin == 1 && (isequal(lower(varargin{1}), 'audapter_matlab_peds')))   
    addpath(fullfile(dl, 'speechres\commonmcode_peds'));
    addpath(fullfile(dl, 'speechres\audpater_matlab_peds\mcode'));
    addpath(fullfile(dl, 'speechres\audpater_matlab_peds\example_data_peds'));
    addpath(fullfile(dl, 'speechres\audapter\Audapter-2.1\BIN\Release'));
    
    cd(fullfile(dl, 'speechres\audpater_matlab_peds\mcode'));    
%%%%%%%    
