...
function Pediatric_Final_Pitch_Reflex_Sustained()
% clear all;
close all;
clc;
tstart = tic;
...
%%
ostFN = '../example_data_peds/online_pitch_reflex_sustainedPED.ost'; %opens up a file in "example data" saying there will be fives rule - detect the voicing onset, wait, pitch shift after .35 ms, wait, and end
pcfFN = '../example_data_peds/online_pitch_reflex_sustainedPED.pcf'; %sets perturbation to zero, will be written over each trial
%ostFN = '../example_data/online_pitch_reflex.ost'; %opens up a file in "example data" saying there will be fives rule - detect the voicing onset, wait, pitch shift after .35 ms, wait, and end
%pcfFN = '../example_data/online_pitch_reflex.pcf'; %sets perturbation to zero, will be written over each trial
